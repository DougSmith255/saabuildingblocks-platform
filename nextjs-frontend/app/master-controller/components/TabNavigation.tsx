...
import { Type, Palette, LayoutGrid, Package, Users, FileText } from 'lucide-react';
import { useControllerStore } from '../stores/controllerStore';

export type TabId = 'typography' | 'colors' | 'spacing' | 'components' | 'templates' | 'user-management';
