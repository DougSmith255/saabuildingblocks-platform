...
/**
 * MarketInsights Template Component
 *
 * Category template for 'market-insights' showcasing market trends,
 * analysis, data, and real estate intelligence.
 *
 * @module category-templates/templates/MarketInsights
 */
...
export default function MarketInsights({ category, posts, settings }: TemplateProps) {
  const features = [
    {
      icon: <LineChart className="h-8 w-8" />,
      title: "Market Trend Analysis",
      description: "Real-time data and predictive analytics covering pricing trends, inventory levels, and market velocity"
    },
    {
      icon: <TrendingUp className="h-8 w-8" />,
      title: "Economic Indicators",
      description: "Track interest rates, employment data, and economic factors influencing real estate markets"
    },
    {
      icon: <PieChart className="h-8 w-8" />,
      title: "Demographic Insights",
      description: "Understand buyer behavior, migration patterns, and demographic shifts shaping market opportunities"
    },
    {
      icon: <BarChart className="h-8 w-8" />,
      title: "Competitive Intelligence",
      description: "Benchmark performance against market averages and identify competitive advantages in your territory"
    }
  ];
    ...
    <div className="min-h-screen bg-black text-[#dcdbd5]">
      <TemplateSection disableAnimation>
        <TemplateHero
          ...
          subtitle="Stay ahead of the curve with data-driven market intelligence, trends, and analysis from industry experts"
          ctaText="View Market Data"
          ctaLink="/contact"
        />
      </TemplateSection>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="mb-12 text-center">
            ...
            <p className="mx-auto max-w-2xl text-[clamp(1rem,2vw,1.125rem)] text-[#dcdbd5] font-[var(--font-amulya)]">
              Access comprehensive market intelligence to advise clients with confidence and identify opportunities
            </p>
          </div>
      ...
      <TemplateSection>
        <div className="mx-auto max-w-6xl">
          <div className="mb-12 text-center">
            ...
            <p className="mx-auto max-w-2xl text-[clamp(1rem,2vw,1.125rem)] text-[#dcdbd5] font-[var(--font-amulya)]">
              Expert analysis and insights to help you navigate market conditions
            </p>
          </div>
          ...
          {posts.length > 0 ? (
            ...
            <div className="rounded-lg border border-[#00ff88]/20 bg-[#0a0a0a] p-12 text-center">
              <p className="text-[clamp(1rem,2vw,1.125rem)] text-[#dcdbd5] font-[var(--font-amulya)]">
                No market insights available yet. Check back soon!
              </p>
            </div>
          )}
        </div>
      ...
      <TemplateSection>
        <div className="mx-auto max-w-5xl">
          <TemplateCTA
            heading="Make Smarter Decisions with Data"
            description="Join eXp Realty and gain access to premium market intelligence tools that give you a competitive edge in every transaction."
