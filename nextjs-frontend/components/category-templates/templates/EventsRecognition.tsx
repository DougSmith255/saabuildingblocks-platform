...
/**
 * EventsRecognition Template Component
 *
 * Category template for 'events-recognition' showcasing company events,
 * agent recognition, awards, and celebrations.
 *
 * @module category-templates/templates/EventsRecognition
 */
...
export default function EventsRecognition({ category, posts, settings }: TemplateProps) {
  const features = [
    {
      icon: <Calendar className="h-8 w-8" />,
      title: "EXPCON Annual Convention",
      description: "The premier real estate event of the year featuring keynote speakers, training, and networking opportunities"
    },
    {
      icon: <Trophy className="h-8 w-8" />,
      title: "Performance Awards",
      description: "Recognition programs celebrating top producers, innovators, and agents who exemplify excellence"
    },
    {
      icon: <Star className="h-8 w-8" />,
      title: "Regional Meetups",
      description: "Local and regional gatherings fostering community connections and collaborative learning"
    },
    {
      icon: <PartyPopper className="h-8 w-8" />,
      title: "Milestone Celebrations",
      description: "Company-wide celebrations of achievements, launches, and significant business milestones"
    }
  ];
    ...
    <div className="min-h-screen bg-black text-[#dcdbd5]">
      <TemplateSection disableAnimation>
        <TemplateHero
          ...
          subtitle="Celebrate success, connect with peers, and be recognized for your achievements at world-class events and programs"
          ctaText="View Events"
          ctaLink="/contact"
        />
      </TemplateSection>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="mb-12 text-center">
            ...
            <p className="mx-auto max-w-2xl text-[clamp(1rem,2vw,1.125rem)] text-[#dcdbd5] font-[var(--font-amulya)]">
              Join incredible events, earn recognition for your achievements, and celebrate alongside your peers
            </p>
          </div>
      ...
      <TemplateSection>
        <div className="mx-auto max-w-6xl">
          <div className="mb-12 text-center">
            ...
            <p className="mx-auto max-w-2xl text-[clamp(1rem,2vw,1.125rem)] text-[#dcdbd5] font-[var(--font-amulya)]">
              Relive memorable moments and see who's being recognized
            </p>
          </div>
          ...
          {posts.length > 0 ? (
            ...
            <div className="rounded-lg border border-[#00ff88]/20 bg-[#0a0a0a] p-12 text-center">
              <p className="text-[clamp(1rem,2vw,1.125rem)] text-[#dcdbd5] font-[var(--font-amulya)]">
                No event updates available yet. Check back soon!
              </p>
            </div>
          )}
        </div>
      ...
      <TemplateSection>
        <div className="mx-auto max-w-5xl">
          <TemplateCTA
            ...
            description="Join eXp Realty and participate in events that inspire, recognize achievements, and foster lasting connections with industry leaders."
