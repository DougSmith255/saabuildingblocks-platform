...
/**
 * CultureCommunity Template Component
 *
 * Category template for 'culture-community' showcasing eXp Realty's
 * collaborative culture, community events, and agent network.
 *
 * @module category-templates/templates/CultureCommunity
 */
...
export default function CultureCommunity({ category, posts, settings }: TemplateProps) {
  const features = [
    {
      icon: <Heart className="h-8 w-8" />,
      title: "Agent-First Philosophy",
      description: "Built by agents, for agents - our culture prioritizes your success, well-being, and professional fulfillment"
    },
    {
      icon: <Users2 className="h-8 w-8" />,
      title: "Global Network",
      description: "Connect with 85,000+ professionals worldwide through local meetups, regional events, and online communities"
    },
    {
      icon: <MessageSquare className="h-8 w-8" />,
      title: "Collaboration Culture",
      description: "Open communication channels, peer mentorship, and knowledge sharing across all experience levels"
    },
    {
      icon: <Sparkles className="h-8 w-8" />,
      title: "Recognition Programs",
      description: "Celebrate achievements with awards, incentives, and public recognition for excellence and contribution"
    }
  ];
    ...
    <div className="min-h-screen bg-black text-[#dcdbd5]">
      <TemplateSection disableAnimation>
        <TemplateHero
          ...
          subtitle="Join a thriving community of real estate professionals united by collaboration, innovation, and shared success"
        ...
        <div className="mx-auto max-w-6xl">
          <div className="mb-12 text-center">
            ...
            <p className="mx-auto max-w-2xl text-[clamp(1rem,2vw,1.125rem)] text-[#dcdbd5] font-[var(--font-amulya)]">
              Experience a supportive environment where agents help agents succeed through shared knowledge and mutual growth
            </p>
          </div>
      ...
      <TemplateSection>
        <div className="mx-auto max-w-6xl">
          <div className="mb-12 text-center">
            ...
            <p className="mx-auto max-w-2xl text-[clamp(1rem,2vw,1.125rem)] text-[#dcdbd5] font-[var(--font-amulya)]">
              Discover how our culture empowers agents to achieve their goals
            </p>
          </div>
          ...
          {posts.length > 0 ? (
            ...
            <div className="rounded-lg border border-[#00ff88]/20 bg-[#0a0a0a] p-12 text-center">
              <p className="text-[clamp(1rem,2vw,1.125rem)] text-[#dcdbd5] font-[var(--font-amulya)]">
                No community stories available yet. Check back soon!
              </p>
            </div>
          )}
        </div>
      ...
      <TemplateSection>
        <div className="mx-auto max-w-5xl">
          <TemplateCTA
            heading="Become Part of Something Bigger"
            description="Experience the power of community at eXp Realty. Connect with like-minded professionals, share knowledge, and grow together."
            ctaText="Join Our Community"
            ctaLink="/contact"
          />
        </div>
