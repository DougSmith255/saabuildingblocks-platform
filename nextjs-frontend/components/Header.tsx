            ...
            {navItems.map((item, index) => (
              ...
              >
                {item.dropdown ? (
                  <>
                    <button
                      className="nav-link flex items-center px-5 py-3 text-white font-['Synonym'] font-medium text-lg tracking-[0.5px] transition-all duration-300 rounded-md mx-[2px] bg-transparent hover:bg-[rgba(42,42,42,0.8)] hover:text-white"
                      style={{
                    ...
                    >
                      {item.dropdown.map((dropdownItem, dropdownIndex) => (
                        <Link
                          ...
                          className="dropdown-item block px-4 py-3 text-white font-['Synonym'] text-base transition-all duration-300 bg-[rgba(42,42,42,0.8)] rounded-lg my-[5.5px] hover:bg-[rgba(58,58,58,0.8)] hover:text-white"
                          style={{
                            willChange: 'background-color, color',
                          }}
                        >
                  ...
                  <Link
                    ...
                    className={`nav-link agent-portal flex items-center px-5 py-3 font-medium text-lg tracking-[0.5px] transition-all duration-300 rounded-md mx-[2px] bg-transparent text-white font-['Taskor'] font-normal ${isPortalClicked ? 'clicked' : ''}`}
                    style={{
                      willChange: 'background-color, color',
                    }}
                  >
                    ...
                    {item.dropdown ? (
                      <>
                        <button
                          ...
                          className="w-full flex items-center justify-between px-6 py-4 text-white font-['Synonym'] font-medium text-[23px] tracking-wide transition-all duration-300 rounded-lg hover:bg-[rgba(42,42,42,0.8)]"
                        >
                          {item.label}
                          <span
                            ...
                            >
                              {item.dropdown.map((dropdownItem, dropdownIndex) => (
                                <Link
                                  ...
                                  className="block px-6 py-3 text-white font-['Synonym'] text-lg transition-all duration-300 rounded-lg my-1 hover:bg-[rgba(42,42,42,0.8)] hover:text-[#ffe000]"
                                >
                                  {dropdownItem.label}
                                </Link>
                              ))}
                      ...
                      <Link
                        ...
                        className={`agent-portal-mobile block px-6 py-4 font-medium text-[23px] tracking-wide transition-all duration-300 rounded-lg relative text-white font-['Taskor'] font-normal ${isPortalClicked ? 'clicked' : ''}`}
                      >
                        <span className="agent-portal-styled">
                          ag<span className="alt-glyph">e</span>
                          <span className="alt-glyph">n</span>
                      ...
                      <Link
                        href={item.href!}
                        onClick={() => setIsMobileMenuOpen(false)}
                        className="block px-6 py-4 text-white font-['Synonym'] font-medium text-[23px] tracking-wide transition-all duration-300 rounded-lg hover:bg-[rgba(42,42,42,0.8)]"
                      >
                        {item.label}
                      </Link>
                    )}
