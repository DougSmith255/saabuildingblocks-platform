...
export function MeetTheFounders() {
  ...
  return (
    <section ref={ref} className="py-16 md:py-24 px-6 relative">
      ...
      {/* 3D Glass Plate Background - Deep amber/orange tint */}
      <div
        className="absolute inset-x-0 inset-y-0 pointer-events-none rounded-3xl overflow-hidden z-[1]"
        style={{
          background: 'linear-gradient(180deg, rgba(255,150,0,0.04) 0%, rgba(255,120,0,0.05) 50%, rgba(255,150,0,0.04) 100%)',
          borderTop: '1px solid rgba(255,160,0,0.12)',
          borderBottom: '2px solid rgba(0,0,0,0.6)',
          boxShadow: `
            inset 0 1px 0 rgba(255,160,0,0.08),
            inset 0 2px 4px rgba(255,140,0,0.03),
