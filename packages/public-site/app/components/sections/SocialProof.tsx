      ...
      <div className="max-w-[1900px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          {proofItems.map((item, index) => (
            <div
              key={index}
              className="flex flex-col items-center text-center p-6 md:p-8 rounded-xl bg-white/5 border border-white/10 hover:border-[#ffd700]/30 transition-all duration-300"
            >
              {/* Icon */}
