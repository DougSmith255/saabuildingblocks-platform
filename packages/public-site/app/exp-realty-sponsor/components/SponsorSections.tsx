      ...
      <ul className="space-y-2 pl-1">
        {SPONSORSHIP_BULLETS.map((b, i) => (
          <li key={i} className="flex items-start gap-2.5 text-body" style={{ color: '#dcdbd5' }}>
            <span
              className="mt-[12px] flex-shrink-0 w-2 h-2 rounded-full"
              style={{
                ...
                <ul className="space-y-4">
                  {[
                    ...
                    <li key={i} className="flex items-start gap-3 text-body">
                      <span className="flex-shrink-0 w-2 h-2 rounded-full mt-[12px]" style={{ background: '#ffd700', boxShadow: '0 0 6px rgba(255,215,0,0.3)' }} />
                      {item}
                    </li>
                  ))}
                </ul>
...
function Section2() {
  ...
  const goldDot = <span className="flex-shrink-0 w-2 h-2 rounded-full mt-[12px]" style={{ background: '#ffd700', boxShadow: '0 0 6px rgba(255,215,0,0.3)' }} />;
...
/**
 * SponsorSections - All below-fold sections for the sponsor page
 * Extracted for code-splitting via dynamic import.
 */
