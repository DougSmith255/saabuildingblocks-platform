  ...
  <style>
    ...
    *, *::before, *::after {
    ...
    .social-link {
      width: 32px;
      height: 32px;
      background: rgba(${rgbString}, 0.13);
      border: 1px solid rgba(${rgbString}, 0.25);
      border-radius: 50%;
      display: flex;
      align-items: center;
      justify-content: center;
    ...
    .social-link:hover {
      transform: translateY(-2px);
      background: rgba(${rgbString}, 0.25);
      ...
      <a href="${siteUrl}/" class="footer-logo">
        <svg class="footer-logo-svg" viewBox="0 0 201.96256 75.736626" xmlns="http://www.w3.org/2000/svg">
          ...
          <g transform="translate(-5.5133704,-105.97189)">
            ...
            <path fill="url(#footerLogoGradient)" d="m 33.71314,127.06681 c -0.644922,-0.55276 -1.868417,-1.61286 -2.718877,-2.35578 C 28.5887,122.6096 17.54033,106.32825 20.700077,106.24689 c 18.520277,-0.47684 31.530155,-0.22018 43.622587,-0.0695 12.878883,18.49983 14.110357,21.6067 12.221476,21.31699 -20.587891,-5.5e-4 -41.658407,0.57749 -42.830997,-0.42752 z"/>
          </g>
        </svg>
