...
const WILDCARD_REDIRECTS = [
  ...
  ['/become-real-estate-agent/schools/', '/real-estate-schools/', true],
  ['/become-real-estate-agent/license/', '/become-an-agent/', true],
  ['/become-real-estate-agent/', '/become-an-agent/', false],
...
const STATIC_REDIRECTS = new Map([
  ...
  ['/how-hard-is-the-real-estate-exam', '/become-an-agent/'],
  ['/pros-and-cons-of-360training', '/real-estate-schools/'],
