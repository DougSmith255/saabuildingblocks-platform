...
/**
 * GenericCyberCardGold - Dark card with grainy texture and subtle grey border
 *
 * Combines GenericCard's subtle border with CyberCardGold's grainy texture.
 *
 * Features:
    ...
    <>
      <style jsx global>{`
        .generic-cyber-card-gold {
          ...
          /* Using same transparency as CyberCardGold (0.85-0.92) for visible grain */
          background:
