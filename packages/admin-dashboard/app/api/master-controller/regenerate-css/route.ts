...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    // Note: Auto-commit removed - now handled by GitHub Actions workflow
    // When you click "Deploy to Cloudflare", the workflow will auto-commit any pending CSS changes

    return NextResponse.json({
      success: true,
      message: 'CSS regenerated successfully. Click "Deploy to Cloudflare" to commit and deploy.',
      data: {
        ...
        note: 'CSS changes will be auto-committed when you deploy to Cloudflare',
      },
    });
