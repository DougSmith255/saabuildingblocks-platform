...
export function BasicScrollportExample() {
  ...
  return (
    <div>
      {/* TODO: Scrollport component not yet migrated
      <Scrollport
        items={items}
        showArrows
...
export function BasicScrollGalleryExample() {
  ...
  return (
    <div>
      {/* TODO: ScrollGallery component not yet migrated
      <ScrollGallery
        items={items}
        showArrows
        showIndicators
...
export function CombinedExample() {
  ...
  return (
    <div>
      {/* TODO: Scrollport and ScrollGallery components not yet migrated
      {/* Navigation *\/}
      <Scrollport
        items={sections}
        enableScrollToSection
...
export function ResponsiveGalleryExample() {
  ...
  return (
    <div className="responsive-gallery-wrapper">
      <p>TODO: ScrollGallery component not yet migrated</p>
    </div>
  );
}
