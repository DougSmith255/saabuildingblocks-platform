...
const socialIcons: SocialIcon[] = [
  ...
  {
    name: 'Webinar',
    href: 'https://smartagentalliance.com/join-exp-sponsor-team/webinar-registration/',
  ...
  {
    name: 'Book a Call',
    href: 'https://smartagentalliance.com/book-a-call/',
    ...
    <footer ref={footerRef} role="contentinfo" className="footer-wrapper">
      <div className="footer-container">
        ...
        <div className="footer-logo">
          <a href="https://smartagentalliance.com/" className="footer-logo-container" aria-label="Smart Agent Alliance Home">
        ...
        <div className="footer-social">
          <nav className="links">
            {socialIcons.map((social, index) => (
              <a
                key={social.name}
                className={`link ${animatingIcons.has(index) ? 'wave-animate' : ''}`}
                href={social.href}
                style={{ '--icon': social.icon } as React.CSSProperties}
                target="_blank"
        ...
        <div className="footer-bottom">
          <div className="footer-nav-links">
            <a href="https://smartagentalliance.com/privacy-policy/" className="footer-nav-link">Privacy Policy</a>
            <a href="https://smartagentalliance.com/disclaimer/" className="footer-nav-link">Disclaimer</a>
            <a href="https://smartagentalliance.com/terms-of-use/" className="footer-nav-link">Terms of Use</a>
          </div>
